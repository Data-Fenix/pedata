...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            rename_columns.py --repo "Exazyme/test_example_dataset_ha1" --col_mapping '{"target kcat per kmol": "target_kcat_per_kmol", "aa_unirep_1900": "aa unirep 1900"}'"""
        )
    )
    # required arguments
    parser.add_argument(
    ...
    # Example usage:
    # python src/pedata/exazyme_datasets/rename_columns.py --repo "Exazyme/test_example_dataset_ha1" --col_mapping '{"target kcat per kmol": "target_kcat_per_kmol", "aa_unirep_1900": "aa unirep 1900"}'
