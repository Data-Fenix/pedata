...
def dataset():
    return load_data("src/pedata/static/example_data/pytorch_dataloader.parquet")
...
def odd_dataset():
    ...
    return load_data("src/pedata/static/example_data/pytorch_dataloader_odd.parquet")
